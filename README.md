...
## (Solved) My Submission & Solution

This is my submission of the following challenge (Information provided below). Code for training and testing the model is present in `train_model.py` and `test_model.py` files respectively.

My terminal output for the scores obtained in the three categories:

```text
Category 1 Score: 0.498
Category 2 Score: 0.509
Category 3 Score: 0.503
```
